...
const PersonalMessageArea = ({
  ...
  return (
    <div className="flex flex-col   items-center w-full h-full">
      ...
      <section
        ref={messagesRef}
        className="flex-1 flex-col items-start flex gap-2  pb-10 bg-secondary p-2 overflow-y-auto w-full border-secondary transition-all duration-300 ease-in-out main-scrollbar"
