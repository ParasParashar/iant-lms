...
const LoginPage = () => {
  return (
    <>
      <div className=" w-screen h-full relative overflow-hidden m-auto ">
        <Image
          ...
          <div className="flex flex-col items-center justify-evenly gap-20 max-lg:gap-8">
            ...
            <div className="flex items-center gap-8 max-lg:flex-col max-lg:gap-8">
              <div className="gap-10 flex flex-col max-lg:items-center max-lg:gap-6">
                ...
                <div className=" text-nowrap text-4xl text-gray-600 pb-6 max-lg:pb-2 max-lg:text-3xl max-md:text-2xl max-lg:text-center leading-[1.5] font-sans font-[900]">
                  <span>Walcome In</span><br/>
