...
const NotesLayout = ({ childern }) => {
  return (
    <div className="flex flex-col gap-y-5 h-full overflow-y-auto main-scrollbar">
      <Navbar />
      <div className="px-10 lg:px-40 flex w-full gap-5 mt-[80px] min-h-full">
        <NotesSidebar />
        <main className="flex flex-col gap-5 rounded-xl text-black  w-full">
          <NotesNavbar/>
